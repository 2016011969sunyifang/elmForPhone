 <template>
  <div>
    <div v-if="!showLoading" class="shop_container">
      ...
      <transition name="fade-choose">
        <div v-show="changeShowType == 'food'" class="food_container">
          ...
          <div class="buy_cart_container">
            <div @click="toggleCartList" class="cart_icon_num">
              <div
    ...
    <div class="animation_opactiy shop_back_svg_container" v-if="showLoading">
...
export default {
  ...
  mounted() {
    ...
    // window.console.log(this.shopDetailData);
  },
  beforeDestroy() {
